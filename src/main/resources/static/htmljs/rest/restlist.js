...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel:[
            ...
            {label:'员工',name:'userName', editable: true },
            {label:'休息时间始',name:'timeStart', editable: true ,formatter:formatDatebox},
            {label:'休息时间止',name:'timeEnd',  editable: true,formatter:formatDatebox},
