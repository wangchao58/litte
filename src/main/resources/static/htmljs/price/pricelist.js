...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel:[
            ...
            {label:'项目名',name:'project', editable: true },
            {label:'价格',name:'price', editable: true },
            {label:'店员',name:'userName',  editable: true},
...
function openEditDiag(uuid) {
    ...
    var indext = layer.open({
        ...
        fixed: false, //不固定
        maxmin: true,
        content: '/price/updPriceView?id='+uuid,
        btn:['确定','取消'],
